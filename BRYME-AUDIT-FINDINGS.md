...
| A8 | P2 | Desk programs: Money jurisdiction clarity banner, Ent thin-catalogue analysis, Sport timestamps, Home problem-intent, Tech clusters, Writers DB protection | per-desk | Owner brief §desk programs | Per-desk work plans after A3–A5 | **Money jurisdiction: FIXED** — every Money content page byline now states Lagos-edited / rules vary by country / cited sources show the jurisdiction; hub dek carries the same promise. 101 content pages + hub, renderer-level. Remaining: Ent catalogue, Sport timestamps, Home intent, Tech clusters, Writers DB |

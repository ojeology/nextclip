...
| A8 | P2 | Desk programs: Money jurisdiction clarity banner, Ent thin-catalogue analysis, Sport timestamps, Home problem-intent, Tech clusters, Writers DB protection | per-desk | Owner brief §desk programs | Per-desk work plans after A3–A5 | **Money: FIXED** (jurisdiction byline on 101 pages + hub dek, live-verified). **Ent: analysis done** (owner decision on card sitemaps). **Sport: verified closed**. Remaining: Home problem-intent, Tech clusters, Writers DB protection |

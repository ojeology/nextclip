...
(function(){
  ...
  var MATCHES={
    ...
    "mancity-bournemouth":{
      ...
      chapters:[
        {imgs:["mc-01.jpg","mc-02.jpg","mc-03.jpg","mc-04.jpg"],audio:"mc-ch01.mp3",tag:"New season",min:"PRE-MATCH",h:0,a:0,st:"build",title:"New season. New era. New assignment.",
         cap:[["🎙️ Commentator","Etihad packed! New season, new manager — Bournemouth no come sightseeing.","c"],["City fan","Omo, new season don start! Today na three points o!","hm"],["Bournemouth manager","Focus. We play our football. Let's make them uncomfortable.","aw"]]},
        {imgs:["mc-05.jpg","mc-06.jpg","mc-07.jpg"],audio:"mc-ch02.mp3",tag:"AND WE DON START",min:"5'",h:0,a:0,st:"live",title:"City knock the door — keeper say no!",
         cap:[["🎙️ Commentator","And we don start! Five minutes in, City dey knock door. Then — beast-mode save!","c"],["City striker","HOW?! That one suppose enter!","hm"],["Bournemouth keeper","Not today. I dey here.","aw"]]},
        {imgs:["mc-08.jpg","mc-09.jpg","mc-10.jpg"],audio:"mc-ch03.mp3",tag:"GOAL · Bournemouth",min:"26'",h:0,a:1,st:"live",title:"Boom — Bournemouth strike first!",
         cap:[["🎙️ Commentator","One second City dey attack. Next second dem dey defend. Boom! Bournemouth lead!","c"],["Bournemouth attacker","WE DON SCORE! Make City chase us now!","aw"],["City defender","How? We were attacking five seconds ago.","hm"]]},
        {imgs:["mc-11.jpg","mc-12.jpg","mc-13.jpg","mc-14.jpg"],audio:"mc-ch04.mp3",tag:"HALF TIME",min:"HT",h:0,a:1,st:"ht",title:"The assist was sweet. The finish was not.",
         cap:[["🎙️ Commentator","City change gear. Chance miss. Half-time: Bournemouth one, City nil.","c"],["City player","We get the ball. Ball no dey enter net by itself.","hm"],["Bournemouth player","Don't relax. City will come. Second half na survival.","aw"]]},
        {imgs:["mc-15.jpg","mc-16.jpg"],audio:"mc-ch05.mp3",tag:"The bench",min:"75'",h:0,a:1,st:"live",title:"The game needed something different.",
         cap:[["🎙️ Commentator","City look to the bench. The clock dey run. Bournemouth still holding on.","c"],["Creative midfielder","Give me the ball. Go change the game.","hm"],["Bournemouth defender","Who be this? New problem. Clear am!","aw"]]},
        {imgs:["mc-17.jpg","mc-18.jpg","mc-19.jpg"],audio:"mc-ch06.mp3",tag:"GOAL · 84'",min:"84'",h:1,a:1,st:"live",title:"84' — equaliser from the corner!",
         cap:[["🎙️ Commentator","Eighty-four minutes! Header from the corner! Equaliser! Bournemouth held out for 83.","c"],["City goalscorer","WE'RE BACK! One more! Everybody push!","hm"],["Bournemouth player","How we lose this lead? Abeg, just survive!","aw"]]},
        {imgs:["mc-20.jpg","mc-21.jpg","mc-22.jpg"],audio:"mc-ch07.mp3",tag:"GOAL · 90+1'",min:"90+1'",h:2,a:1,st:"live",title:"90+1' — comeback complete!",
         cap:[["🎙️ Commentator","Ninety plus one! Bottom corner! VAR check... GOAL CONFIRMED. Two-one!","c"],["City goalscorer","WE DON WIN AM! Last minute!","hm"],["Bournemouth defender","HOW?! We were winning!","aw"]]},
        {imgs:["mc-23.jpg","mc-24.jpg","mc-25.jpg","mc-26.jpg"],audio:"mc-ch08.mp3",tag:"Full time",min:"FT",h:2,a:1,st:"ft",title:"Football no get script.",
         cap:[["🎙️ Commentator","Full time. City two, Bournemouth one. Minutes from a famous win. City had other plans.","c"],["City fan","Na why you dey watch football till 90+? Football fit disgrace you anytime!","hm"],["Bournemouth fan","Abeg, I no dey talk to anybody. Football no get pity.","aw"]]}
      ]
    },
    "newcastle-liverpool":{

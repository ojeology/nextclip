/* BRYME Match Comic — restructured. 10 themed chapters.
   Images AND the single caption both track the AUDIO progress (never outrun it).
   One caption line at a time (no overlap, clean fade). Auto-builds into #mc-hero. */
(function(){
  ...
  var S=[
    {imgs:["01.jpg","19.jpg"],audio:"hu-ch01.mp3",tag:"Homecoming",min:"PRE-MATCH",h:0,a:0,st:"build",title:"9 years done — Tigers return!",
     cap:[["🎙️ Commentator","Nine years for relegation jail don end! Hull enter Premier League like person wey collect alert! MKM dey burst!","c"],
    ...
    {imgs:["13.jpg","20.jpg","02.jpg","14.jpg","15.jpg"],audio:"hu-ch02.mp3",tag:"1' · Kick-off",min:"1'",h:0,a:0,st:"live",title:"Whistle blow — Hull press!",
     cap:[["🎙️ Commentator","Teams dey tunnel, eye dey red! Whistle blow — Hull press like say dem no get brake!","c"],
          ["Hull player","We no go give dem breathing space! Press, press, press!","h"],
          ["United player","These boys dey run like say dem drink fuel! Calm down na!","u"]]},
    {imgs:["03.jpg","21.jpg"],audio:"hu-ch03.mp3",tag:"12' · Save",min:"12'",h:0,a:0,st:"live",title:"Tzolakis catch am like rent!",
     cap:[["🎙️ Commentator","Tzolakis catch ball like landlord wey come collect house rent! E be like say he get three hands!","c"],
    ...
    {imgs:["04.jpg","05.jpg","06.jpg","22.jpg"],audio:"hu-ch04.mp3",tag:"17' · GOAL",min:"17'",h:1,a:0,st:"live",title:"Corner → header → AJAYI goal!",
     cap:[["🎙️ Commentator","Corner kick — setup dey load! McBurnie head am… saved! But Ajayi pounce on the rebound — GOOOAL!","c"],
    ...
    {imgs:["07.jpg","24.jpg"],audio:"hu-ch05.mp3",tag:"1–0 · Scene",min:"17'",h:1,a:0,st:"live",title:"MKM don turn mad house!",
     cap:[["🎙️ Commentator","MKM Stadium don turn mad house! Nine years of waiting, e don pay!","c"],
    ...
    {imgs:["16.jpg","23.jpg","08.jpg"],audio:"hu-ch06.mp3",tag:"34' · Bruno hot",min:"34'",h:1,a:0,st:"live",title:"Bruno dey blame everybody!",
     cap:[["🎙️ Commentator","Bruno don dey hot! He dey blame referee, ball, even the wind! Then Dorgu see yellow!","c"],
          ["Bruno Fernandes","Wetin be this?! Nobody dey mark!","u"],
    ...
    {imgs:["09.jpg","10.jpg","24.jpg"],audio:"hu-ch07.mp3",tag:"38' · GOAL",min:"38'",h:2,a:0,st:"live",title:"Free kick → MENDY header! 2–0!",
     cap:[["🎙️ Commentator","Free kick — danger dey load! Mendy rise like helicopter for set-piece — two nil o!","c"],
          ["Mendy","Fly high! Another set piece chop una clean!","h"],
          ["Bruno Fernandes","How we con leave tall man for free header again?!","u"]]},
    {imgs:["11.jpg","17.jpg"],audio:"hu-ch08.mp3",tag:"60' · Possession",min:"60'",h:2,a:0,st:"live",title:"72% award vs 3 points",
     cap:[["🎙️ Commentator","United get 72% possession award, but Hull fans dey count their 3 points! Wall no dey move!","c"],
          ["United player","Omo, we get 72% possession o! We dey dictate!","u"],
          ["Hull defender","Sorry say possession no dey inside soup. 2-0 remains 2-0!","h"]]},
    {imgs:["18.jpg","25.jpg"],audio:"hu-ch09.mp3",tag:"78' · Double save",min:"78'",h:2,a:0,st:"live",title:"Tzolakis wall no dey break!",
     cap:[["🎙️ Commentator","Tzolakis don do double save o! First the shot, then the rebound! Wall no dey break!","c"],
          ["Tzolakis","Anything wey enter my box, I go commot!","h"],
    ...
    {imgs:["12.jpg","26.jpg"],audio:"hu-ch10.mp3",tag:"Full time",min:"FT",h:2,a:0,st:"ft",title:"Red Devils? Crying Devils!",
     cap:[["🎙️ Commentator","Full time! Red Devils? Crying Devils proper! Tigers are back — and we starving!","c"],
          ["Rashford","We come all this way only to chop premium tears.","u"],
          ["Hull captain","Go tell them say the Tigers are back!","h"]]}
  ];
  var PILL={build:"BUILD-UP",live:"LIVE",ht:"HALF TIME",ft:"FULL TIME"};
  var CAP_DUR=4200;   // muted: on-screen time per caption line
  function init(){

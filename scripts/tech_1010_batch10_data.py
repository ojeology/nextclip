...
SOURCES = [
    ...
    ("NCSC — Top tips for staying secure online: public networks can carry unencrypted traffic, so use strong device protection and a VPN on public Wi-Fi", "https://www.ncsc.gov.uk/collection/top-tips-for-staying-secure-online"),

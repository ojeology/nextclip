...
@media(max-width:760px){
 .shell{width:min(calc(100% - 24px),var(--max))}.top .shell{min-height:58px}.topnav{display:none}.header-search{display:inline-flex}.article-hero{min-height:300px;margin-top:12px;padding:84px 18px 26px}.article-hero h1{font-size:clamp(30px,10vw,44px)}.article-hero .lead{font-size:15px}.article-body,.legal-prose{padding:28px 0 64px}.prose h2{margin-top:32px;font-size:25px}.prose p,.prose li{font-size:16px;line-height:1.72}.grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:11px}.section{padding:40px 0}.section-head h2{font-size:25px}.footer{padding-bottom:84px}.footer-grid{grid-template-columns:1fr 1fr}.footer-brand{grid-column:1/-1}.mobile-nav{position:fixed;z-index:60;left:0;right:0;bottom:0;display:grid;grid-template-columns:repeat(6,1fr);border-top:1px solid var(--line);background:rgba(24, 24, 22, .97);padding-bottom:env(safe-area-inset-bottom,0)}.mobile-nav a{min-width:0;padding:8px 1px;color:var(--muted);text-align:center;font-size:9px;font-weight:800}.mobile-nav a[aria-current="page"]{color:var(--ink);background:rgba(143, 106, 30, .1)}.mobile-nav .mn-ico{display:block;color:var(--accent);font-size:14px}.integrity-notice{width:calc(100% - 24px)}
}

...
<li><b>Pick your country.</b> Each published call names who it is open to. BRYME does not treat a missing country list as "open worldwide" — eligibility and diaspora rules are recorded where the publication states them.</li>
<li><b>Read the official guideline, not the rate card.</b> Every record links to the publication's own guidelines page and shows its last human-check date.</li>
<li><b>Understand the money before you pitch.</b> Payment is the published fee per accepted piece (or the real range), how/when it is paid, and whether it is per published word, per piece or a variable honorarium. Rates are never invented.</li>
<li><b>Check AI policy and rights.</b> Many publications reject AI-assisted work and take specific rights. BRYME records what each page says.</li>
<li><b>Pitch exactly as asked.</b> A call is an invitation to pitch, not a job offer and not a promise of payment. Send what the guideline requests.</li>
<li><b>Track it honestly.</b> For opportunities BRYME has personally tested, the journey is shown as it happens — pitch sent, response, accepted, scheduled, published, paid — and payment is only marked confirmed once it actually lands.</li>
</ol></div></section>

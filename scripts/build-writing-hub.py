...
<script src="/assets/hub-tools.js?v=5" data-hub-tool="freelance-rate-calculator"></script>'''

    if i == "deadline-tracker":
        return '''<div class="tool-box"><div class="tool-prose">
<div class="tool-grid">
<div class="tool-input"><label for="dt-name">What is due</label><input id="dt-name" type="text" maxlength="80" placeholder="Feature for Client X"></div>
<div class="tool-input"><label for="dt-date">Due date</label><input id="dt-date" type="date"></div>
</div>
<div class="tool-actions"><button id="dt-add" class="btn" type="button">Add deadline</button></div>
<p class="tool-note" id="dt-status" aria-live="polite"></p>
<div id="dt-list"></div>
<p class="tool-note">The list lives in this browser only - nothing is uploaded. Clearing site data clears the list, so export anything precious first.</p>
</div></div>
<script src="/assets/hub-tools.js?v=5" data-hub-tool="deadline-tracker"></script>'''

    if i == "tax-estimator":
        return '''<div class="tool-box"><div class="tool-prose">
<div class="tool-grid">
<div class="tool-input"><label for="te-income">What clients will pay you this year (USD)</label><input id="te-income" type="number" min="0" step="500" value="18000"></div>
<div class="tool-input"><label for="te-expenses">Deductible business expenses (USD)</label><input id="te-expenses" type="number" min="0" step="100" value="800"></div>
<div class="tool-input"><label for="te-rate">Set-aside rate (%)</label><input id="te-rate" type="number" min="0" max="90" step="1" value="25"></div>
...
<script src="/assets/hub-tools.js?v=5" data-hub-tool="tax-estimator"></script>'''

    if i == "income-tracker":
        return '''<div class="tool-box"><div class="tool-prose">
<div class="tool-grid">
<div class="tool-input"><label for="it-client">Client / publication</label><input id="it-client" type="text" placeholder="Who paid you"></div>
<div class="tool-input"><label for="it-amount">Amount (USD)</label><input id="it-amount" type="number" min="0" step="10" placeholder="250"></div>
<div class="tool-input"><label for="it-date">Date</label><input id="it-date" type="date"></div>
<div class="tool-input"><label for="it-status">Status</label><select id="it-status"><option value="paid">Paid</option><option value="invoiced">Invoiced</option><option value="pending">Pending</option></select></div>
</div>
<div class="tool-actions"><button id="it-add" class="btn">Add entry</button></div>
<div class="tool-result" id="it-out" aria-live="polite"></div>
<div id="it-list"></div>
...
<script src="/assets/hub-tools.js?v=5" data-hub-tool="income-tracker"></script>'''
...
<script src="/assets/hub-tools.js?v=5" data-hub-tool="structure-quiz"></script>'''
...
<script src="/assets/hub-tools.js?v=5" data-hub-tool="freelance-agreement-builder"></script>'''
...
<script src="/assets/hub-tools.js?v=5" data-hub-tool="invoice-generator"></script>'''
...
<script src="/assets/hub-tools.js?v=5" data-hub-tool="late-payment-letter-builder"></script>'''
...
<script src="/assets/hub-tools.js?v=5" data-hub-tool="pitch-checker"></script>'''
...
<div class="tool-result" id="out" aria-live="polite"></div></div></div>
<script src="/assets/hub-tools.js?v=5" data-hub-tool="word-count-to-pages"></script>'''
...
<div class="tool-result" id="out" aria-live="polite"></div></div></div>
<script src="/assets/hub-tools.js?v=5" data-hub-tool="outline-builder"></script>'''
    if i == "tone-checker":
...
<script src="/assets/hub-tools.js?v=5" data-hub-tool="tone-checker"></script>'''
...
<div class="tool-result" id="out" aria-live="polite"></div></div></div>
<script src="/assets/hub-tools.js?v=5" data-hub-tool="citation-formatter"></script>'''
...
<div class="tool-result" id="out" aria-live="polite"></div></div></div>
<script src="/assets/hub-tools.js?v=5" data-hub-tool="word-alternatives"></script>'''
...
<script src="/assets/hub-tools.js?v=5" data-hub-glossary></script>'''
...
<a class="path-card" href="/writing-opportunities/"><span class="card-num">WORLD</span><h3>Writing by country</h3><p>Pick your country: publications based there, and publications open to you.</p><span class="card-link">Find your country →</span></a>
</div></div></section>'''

...
"Weight: the shelf files it as the box-office-side data point of the FilmOne era - a well-made Lagos thriller that the public took to the multiplex and the critics split over in the exact places a writing room should study - plus the record that it is Akinmolayan's seventh feature and Inkblot's tenth, the studio-era moment when the industry's craft ceiling had risen enough that a flawed film looked this professional. Judged as a thriller: stylish and watchable, undone by its own arithmetic; judged as a lesson: the desk's standing example that in a con film, the twist you cannot afford is the one that cheats the characters.",
    ...
    dict(slug="the-meeting", title="The Meeting", year=2012,
         director="Mildred Okwo", country="Nigeria", language="English", runtime=115,
         axes=dict(story=8.0, craft=7.5, vision=8.0, weight=7.5), score=7.75,
         date="2026-09-21",
         verdict="A government contract turns one overnight hotel lobby into a miniature country, and Mildred Okwo finds comedy in every queue, favour and performance of respect: warm, sharply observed, and still the rare political romance that trusts its ensemble",
         body=[
"Makinde arrives in town with the ordinary desperation of a man trying to secure a government contract, then discovers that the official he needs will not meet him until morning. The hotel room becomes a waiting room, the waiting room becomes a nation, and Tunde Babalola's script understands that patronage is most revealing when nobody is giving a speech about it. Every guest carries a different relationship to power - the person who has access, the person who performs access, the person who has paid for access, and the person who is simply waiting for a signature - and Femi Jacobs makes Makinde's polite panic the audience's way into the maze.",
"Mildred Okwo directs the ensemble like a stage company without flattening the film into theatre. Rita Dominic's Clara is both gatekeeper and person, Kehinde Bankole's Kikelomo has a comic rhythm that can turn in a breath, and Jide Kosoko gives the institutional room a face that is funny because it knows exactly how much authority it is borrowing. The 115-minute shape has room for the hotel to accumulate detail: costumes announce rank, corridors turn private bargains into public theatre, and the blocking makes every entrance a small change in the balance of power. This is craft that does not shout about itself; it lets timing, reaction and the repeated business of waiting do the political work.",
"The film's limitation is the same generosity that makes it pleasant. Its sharper observations are often softened before they can become uncomfortable, and the final emotional arithmetic prefers reconciliation to consequence. A few supporting figures arrive as comic instruments rather than fully lived people, while the central romance has to share oxygen with a satire that is more interested in the institution than in the couple. The hotel can feel like a tidy model of a messier system, and the tidiness is occasionally visible in the seams.",
"Weight: The Meeting was a 2012 release from The Audrey Silva Company, directed and co-written by Okwo and written with Babalola, and its shelf life is earned by the way it turns a recognisable civic frustration into ensemble cinema rather than a lecture. It sits beside the desk's stronger political films because it knows that power is often a room full of people pretending not to wait. Judged as romance, it is tender without being sugary; judged as comedy, it is precise; judged as a film about access, it remains the meeting most viewers have already attended.",
         ]),
    dict(slug="thirty-days-in-atlanta", title="30 Days in Atlanta", year=2014,
         director="Robert Peters", country="Nigeria", language="English", runtime=111,
         axes=dict(story=5.5, craft=6.5, vision=5.5, weight=6.5), score=6.0,
         date="2026-09-21",
         verdict="Ayo Makun exports Akpos from a Lagos family comedy into an Atlanta travel machine: the film is broad, glossy and often funny, but its biggest achievement is industrial scale rather than a story that can survive every stereotype it reaches for",
         body=[
"The premise is a reliable comic engine: Akpos wins a thirty-day trip to Atlanta and takes his cousin Richard, an IT specialist, into a new city full of parties, romance, immigration paperwork and opportunities to misunderstand the room. Ayo Makun knows how to hold an audience through a set piece, and Robert Peters keeps the film moving between Lagos and Atlanta with the confidence of a production that wants to be bigger than the old local comedy template. The jokes arrive quickly, the accents and reversals are legible, and the central travel fantasy gives the audience a simple promise: watch this character collide with a world that refuses to arrange itself around him.",
"The craft is where the film earns its generous moments. The two-location design gives the comedy visual variety, the Atlanta material has the sheen of a genuine expansion rather than a painted backdrop, and the ensemble understands the difference between a lead's noisy confidence and the supporting cast's reaction to it. Ramsey Nouah supplies a useful straight-man counterweight, while the international appearances from Vivica A Fox and Lynn Whitfield give the production a bridge to the audience it is courting. The film's timing works best when it lets the actors play the social discomfort instead of underlining the punchline.",
"The debits are the familiar ones, and they accumulate. Stereotypes do much of the character work, the romantic plot is treated as a reward mechanism, and the story frequently pauses for a joke that has already explained itself. The film can feel like a longer version of its trailer: energetic, audience-aware and reluctant to leave a bit behind. The first hour and a half has competent comic construction, but the final stretch exposes the thinness beneath the travel premise, with predictability doing more work than observation. Broad comedy can be generous; it still needs people who exist when the joke ends.",
"Weight: the 2014 film, written by Patrick Nnamani, produced by Ayo Makun and shot in Lagos and Atlanta, became a major cinema event and was recognised at the time as a record-setting commercial success, even as critics split over its cliches and originality. That distinction is the useful reason to keep it on the shelf. It documents an industry reaching for scale, diaspora visibility and a multiplex audience at once. Judged as a comedy, it is uneven but watchable; judged as a milestone, it is more consequential than its script, a bridge built from laughs that does not always know where the road should go next.",
         ]),

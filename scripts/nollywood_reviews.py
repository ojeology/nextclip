...
"Weight: a film from Senegal and France shot in Congo with a non-professional lead that took a major international jury's second prize and turned a Kinshasa club into the decade's most rewatched African screen space - the shelf's entry for the proof that African art cinema travels on its craft, not its geography, and the one the desk quotes when someone asks what 'world cinema' was actually for. Judged as cinema: eight-point craft, a singer's poise; judged as a night in one city told without pity - which is its own argument in a festival ecosystem that often asked for pity.",
    ...
    dict(slug="fifty", title="Fifty", year=2015,
         director="Biyi Bandele", country="Nigeria", language="English", runtime=None,
         axes=dict(story=7.0, craft=7.5, vision=7.0, weight=7.5), score=7.25,
         date="2026-09-22",
         verdict="Four women, one week before fifty, and the film that proved the Nigerian middle-class interior - Ikoyi penthouse to marriage bed - is a cinema subject: EbonyLife's prestige era at its most assured and most debated",
         body=[
"Four friends - the divorced workaholic, the wife bargaining with time, the wife of a volatile elder statesman, the marriage-and-faith renegotiator - convene for a birthday weekend that keeps being interrupted by the lives they built. Fifty takes the week-before-fifty device, which elsewhere sits comfortably in rom-com territory, and treats it as a verdict year: every relationship in the film is a contract one of these women signed twenty years ago and is now re-reading. Biyi Bandele, adapting with Kemi Adesoye and Bola Agbaje, keeps the camera at conversational distance and lets the arguments run long, which in 2015 Nigerian cinema was itself a statement - the plot here is a woman saying 'no' in a drawing room.",
"The craft is the film's quiet boast: the Ikoyi and Victoria Island locations are shot as a climate rather than an aspiration - heat, water cuts, generators, the specific choreography of wealth under load - and the four leads are given the kind of ensemble screen time the industry spent a decade reserving for male ensembles. Iretiola Doyle's Elizabeth is the desk's pick, a performance built entirely out of micro-recalculations, and Dakore Egbuson's Tola carries the film's hardest scene - the one where the romance loses its argument with the calendar - without a single raised voice. The score and the party set-piece do what prestige was supposed to do: they make the ordinary Nigerian middle class look like material for a two-thousand-seat frame.",
"The ledger's debits are the ones the premiere walkout arguments predicted: a male cast that sometimes exists to be lectured at - Wale Ojo's Kunle is a thesis with a moustache - and an ending in which two of the four women are rewarded by the plot while the other two are corrected by it. The film's Ikoyi bubble is a choice, not a blind spot, but the bubble does make the film's most quotable lines about freedom land slightly soft for anyone whose weekend is not a rooftop party on Banana Island. Half of its reputation as 'not really Nollywood' is the class anxiety the film knowingly exposes; half of it is a fair hit.",
"Weight: Fifty is the pivot title of the 2013-2016 prestige window - the proof that the new industry could bank a women-led ensemble about interior life rather than a genre about the compound, and the reason the deals after it smelled slightly different. It is on this shelf as the film that made 'midlife' and 'Lagos' rhyme in Nigerian cinema, and as the desk's standing answer in the argument that African screens only reward struggle narratives: four women, one week, fifty years - judged as craft, a confident two-hour argument; judged as a moment, the moment the middle class got its close-up.",
         ]),
    dict(slug="breath-of-life", title="Breath of Life", year=2023,
         director="BB Sasore", country="Nigeria / United States", language="English", runtime=114,
         axes=dict(story=7.5, craft=7.0, vision=6.5, weight=7.0), score=7.0,
         date="2026-09-22",
         verdict="A godfather's second chance told in two timelines: Wale Ojo and Chimezie Imo carry a high-concept Nigerian faith drama past its sermon beats and into a genuine argument about the years you waste waiting to be worthy - the one that put Nemsia's name on Amazon's slate",
         body=[
"The conceit is Old Testament in its arithmetic: Timi, the gifted young cleric who loses his wife and child in the act of blaming God for it, is refused the release of death for fifty years - kept alive until he spends what he hoarded on someone else's calling. Breath of Life splits that sentence into a dual timeline, Wale Ojo's embittered old man in the big house, Chimezie Imo's earnest seminarian Elijah arriving as the student he never wanted, and the film's structure is a countdown the audience holds before the characters do. BB Sasore's script is unafraid of the obvious - this is a faith film wearing its thesis openly - and the obvious, executed with this much patience, turns out to be the hard thing: grief dramatised as habit rather than mood, a man so fluent in self-pity it has become architecture.",
"The craft is glossy in the specific way of the production's Amazon-era money, and the desk will not pretend the polish costs nothing - Lagos and its diaspora here get a clean grade, a big score, and an international ensemble (Genoveva Umeh, Eku Edewor, Tina Mba, Sambasa Nzeribe, Sam Dede in the supporting bench) that behaves like a studio cast. Wale Ojo is the film's engine: his third-act collapse - the one scene where fifty years of rehearsal fail - is the best argument on the shelf for acting as a faith discipline, and Imo's counterweight avoids the saint's error by playing hunger, not virtue. The sermon passages that divide audiences are undeniably sermonic; the film earns them the same way the good hymns do, by arriving late enough that the congregation is already weeping.",
"The ledger's debits: a middle hour where the double-timeline starts answering its own questions too neatly, a providence mechanic that occasionally resolves what the drama had earned the right to leave open, and a diaspora-polish that sands off the Lagos grain the film's emotional truth lives in - the compound is beautiful here in a way compounds are not. And the target audience and the crossover audience want different endings; the film, to its credit, refuses to fully be either one's.",
"Weight: the Nemsia production - produced with Eku Edewor among others - landed on Amazon MGM's first Nigerian push in 2023 and out-performed its own hype-cycle as the proof that the faith-market picture could travel as a human picture, and it is also this desk's quiet Tina Mba reminder, one of her last features, which is the kind of thing shelves are actually for. Judged as cinema: a competent sermon that transcends its sermon; judged as a bridge - between the church hall and the streaming homepage, between the morality play and the prestige close-up - it is one of the most consequential Nigerian releases of its year, and it earns its place here for the third act alone.",
         ]),

    dict(slug="ojukokoro", title="Ojukokoro: Madness of Money", year=2019,
         director="Dare Olaitan", country="Nigeria", language="English / Nigerian Pidgin", runtime=112,
         axes=dict(story=7.5, craft=7.0, vision=7.0, weight=6.5), score=7.0,
         date="2026-09-23",
         verdict="A petrol station, a payroll robbery, a kidnapping and nine bad decisions converge in one Lagos afternoon: the heist-comedy grammar of the Guy Ritchie school imported, dirtied and made unmistakably local - the desk's pick for the funniest structural trick Nollywood pulled in the 2010s",
         body=[
"The premise is a joke told as a trap: Andrew, manager of a cash-heavy filling station with exactly the worst possible week, decides to rob his own employer - and the film then opens every other door in the building. A cocaine-adjacent accountant, two draughts-obsessed attendants, a gambler who cannot keep a secret about a payroll, a kidnapped wife, a political godfather's enforcer (Wale Ojo's Mad Dog Max, wearing menace like an ill-fitting suit) - all of them arriving at the same forecourt on the same afternoon with incompatible plans. Dare Olaitan's script runs the intersecting-timelines machine with more discipline than most films twice its budget manage: every coincidence is planted one scene before it detonates, and the Mexican-standoff payoff is earned rather than announced.",
"The craft is quick and clean where it needs to be: the forecourt is shot as a chessboard, the rewrites of time (the same moments replayed from a new angle) cut without a stitch showing, and the ensemble reads as genuinely performed rather than merely assembled - Emmanuel Ikubese's accountant gets the film's best physical-comedy rhythm, Ali Nuhu's grieving husband supplies the one thread that refuses to be funny, and the film is wise enough not to apologise for the tonal swerve. The money in the production shows up where it counts: night, rain, practical cars, one location held long enough to feel like a character. What shows up less kindly is the third act's appetite for explaining its own jokes to late arrivals.",
"The ledger's debits: a few beats of comedy are carried by mugging over writing, one subplot (the kidnapping's ransom arithmetic) outlives its usefulness by fifteen minutes, and the violence, when it lands, is treated with a breeziness the film's better scenes quietly argue against. And the time-juggling device demands attention in a market that rewards rest - the desk notes, fairly, that 'watch it on your phone after work' is exactly the viewing pattern the structure punishes.",
"Weight: Ojukokoro is the title the shelf points at in the decade argument - the proof that the new-wave generation could take a foreign grammar (the Ritchie ensemble-capade), set it on a Lagos petrol forecourt with local logic, and play it to full houses at home and international buyers abroad; it sits here beside Fifty as the 2010s' twin experiments in genre first, industry second. Judged as cinema: a confident comedy of errors with one act too many of explaining; judged as a moment: the moment the heist film became a Nollywood house style, and the reason three successors that followed owed more than they admitted.",
         ]),
    dict(slug="the-milkmaid", title="The Milkmaid (Desert Flower)", year=2020,
         director="Desmond Ovbiagele", country="Nigeria", language="Hausa / Fulfulde", runtime=136,
         axes=dict(story=7.0, craft=7.5, vision=7.5, weight=7.0), score=7.25,
         date="2026-09-23",
         verdict="A Fulani milkmaid walks back into the camp that took her sister: an insurgency thriller that refuses the rescue-movie contract, shot in the Sahel's hard light - Nigeria's Academy Award submission and the desk's argument that the industry's geography is wider than its capital",
         body=[
"Two sisters, a night road, a takeover by men whose flag is stitched from scripture and grievance: what The Milkmaid (released in the West as Desert Flower) does with the kidnapping premise is the whole review. Aisha escapes - and the film then declines every rescue-thriller instruction it has been handed. There is no soldier, no journalist, no second act of pleading; there is a woman walking back toward the camp that has her sister, bargaining with what a milkmaid owns: knowledge of the ground, of the animals, of the people who live beside the men who took her. Desmond Ovbiagele writes the insurgency's marketplace with an anthropologist's patience, and lets the audience feel how a community absorbs an idea it cannot fight.",
"The craft is the film's loudest quiet achievement: Yinka Edward's photography treats the Sahel as a moral condition - heat in the wide shots, terror in the close ones, night lit like rumour - and Michael Truth Ogunlade's score keeps its hands off the strings at the moments a lesser production would drown. Maryam Booth carries the title role on a face that gives away less and means more each take, and the ensemble speaks the film's Hausa and Fulfulde with a fluency that makes the English-subtitle habit feel, for once, like the interruption. The production's care shows in the small frames: the gourds, the milk, the dress-weights - culture as texture, not postcard.",
"The ledger's debits are real and the shelf names them: the middle hour drifts toward the festival register - repetition standing in for escalation, a subplot with the commander's boy that the film would rather not end; and the climax, when the confrontation finally comes, trades the intelligence of everything before it for a gun the story had no need of. Some of the foreign-funding gaze that the film's own success invited is visible at the edges too - the desk credits Ovbiagele for making the film for its community first, and notes that the West's embrace arrived with a vocabulary ('African women in danger') that the movie quietly argues against.",
"Weight: selected as Nigeria's submission for the Best International Feature Film at the 93rd Academy Awards, an African-language winner at the continental awards with eight nominations behind it, and the proof point for the shelf's standing claim that Nollywood's frontier language is Hausa as much as Yoruba, Igbo or English - the film this desk hands to anyone who asks what the Sahel's cinema looks like when it shoots at home instead of explaining itself abroad. Judged as a thriller it is flawed; judged as a claim - that this industry's geography, languages and light belong in the world's arthouse without translation - it is one of the most consequential Nigerian films of its year.",
         ]),

    dict(slug="nneka-the-pretty-serpent", title="Nneka the Pretty Serpent", year=2020,
         director="Bryan Dike & Tosin Igho", country="Nigeria", language="English", runtime=140,
         axes=dict(story=5.5, craft=6.5, vision=6.0, weight=6.0), score=6.0,
         date="2026-09-24",
         verdict="A Netflix-era revenge fantasy that dresses the classic Nneka folktale in soap-opera gloss: beautiful on the surface, thin in the middle, and the desk's cleanest case study in what streaming money did to Nollywood's writing room",
         body=[
"The premise borrows from a national memory - Nneka, the pretty serpent of the 1991 classic, reborn as a streaming serial - and the film version keeps the folktale's engine while replacing its menace with mood: parents murdered in a house that suddenly belongs to powerful people, a drowned queen of the coast offering vengeance as a contract with clauses, and a young woman who trades her fear for a dress and a deadline. What screenwriter Uyoyou Adia builds is an opera of reveals where every suspect arrives pre-costumed and the mystery's answers are less interesting than the wardrobe. The desk watches it as a specimen: this is exactly what the streaming era commissioned when it wanted Nollywood's mythology with a colour grade.",
"The craft is where the money visibly went, and mostly where it should have: the coastal sequences and the underwater queen's court have a production designer's pride, the grade is confident, and the supporting bench - Shaffy Bello's doctor, Femi Branch's detective, Bimbo Ademoye's Ada - play their melodrama with full professional commitment. Idia Aisien carries the title role with the right stillness for a woman half-possessed by an agreement, and Kenneth Okolie's charm does real work opposite her. The film's look is genuinely the shelf's argument that Nollywood's aesthetic ceiling rose a full floor in the Netflix years.",
"The ledger's debits are structural: the mystery's logic is a séance - clues appear when the script needs them and the villain's unmasking underwhelms because every candidate was written as scenery; the pacing runs long by half an hour of subplots that end mid-thought; and the folklore's actual horror - the serpent contract's body-horror price - is traded for romance beats the platform evidently wanted. Where the 1991 original used its poverty like a weapon, this one spends its budget like a shield.",
"Weight: the desk files this as the shelf's turning point between the video era and the algorithm era - the same folktale, two industries, twenty-nine years and a world of production value apart, and an instructive loss of nerve in the retelling. It matters for what it proves about streaming's Nollywood contract: reach, polish, catalogue depth, and a gentle pressure away from strangeness. Judged as a thriller: a pretty one with a loose grip; judged as a document of the industry's moment, one of the most discussed releases of its year, and it earns its shelf entry for the underwater court alone.",
         ]),
    dict(slug="shadow-parties", title="Shadow Parties", year=2021,
         director="Yemi Amodu", country="Nigeria", language="English / Yoruba", runtime=117,
         axes=dict(story=5.5, craft=6.0, vision=6.5, weight=7.0), score=6.25,
         date="2026-09-24",
         verdict="A family torn by a community feud, staged as a Yoruba epic with a feature film's budget and a serial's patience: the desk's verdict lands on ambition over execution - and on the cultural import of the crossover cast",
         body=[
"Two communities, one long-simmering conflict, and a family standing in the seam between them - the attacks, the reprisals, the relatives who become informants because the alternative is the machete: Shadow Parties sets a village feud inside the Yoruba cinema tradition where proverbs carry plot and drums carry verdict. Writer Ade Derek Adeniji and director Yemi Amodu built it as a crossover experiment - the Yoruba-language industry's production scale and performance style staged for the English-market audience, with Omotola Jalade-Ekeinde's return to a leading role as the commercial engine. The result is a film that never quite decides whether its structure is a serial's slow spiral or a feature's clean arc, and the desk's central criticism is exactly that: it is too long for the first and too compressed for the second.",
"The craft lives in the village-wide production: real locations shot with an epic's framing, the masquerade and festival sequences choreographed with evident respect, and a score that treats the drums as narration. The ensemble is the shelf's argument for the Yoruba industry's acting bench - Jide Kosoko's chief carries authority in three scenes where an English-film lead would need monologues, Sola Sobowale does her customary damage with a single raised eyebrow, and Toyin Abraham brings the folk-comedy valve the tragedy needs - while the crossover's English-market half, including the foreign guests, plays in a register the film keeps not quite marrying to the rest. The dubbing and subtitle policy across versions is the production's own honest footnote: this was a bridge, and bridges carry traffic in two directions.",
"The ledger's debits: a mid-section that repeats its own reprisals at escalating length, a villain whose motive arrives as explanation rather than drama, and an action vocabulary borrowed from the Nollywood thriller playbook the film is otherwise busy outgrowing - gunfire that resolves what culture established. And the desk notes for fairness that the pacing complaints belong half to its release shape: cut to four episodes it breathes, held to two hours it strains.",
"Weight: the shelf registers Shadow Parties for what it did at the seam of industries - a Yoruba-scale production with a star crossover and international ambitions, released into a market still learning that Nollywood is plural - plus the same year's quiet record: the Nollywood viewing boom of the pandemic years that this film courted directly. Judged as cinema: ambitious, uneven, watchable in its best hour; judged as an event: the crossover era's most literal attempt, and the desk's standing example that in Nigerian film, the industry in the title is always the plot.",
         ]),

    dict(slug="mokalik", title="Mokalik (Mechanic)", year=2019,
         director="Kunle Afolayan", country="Nigeria", language="English / Yoruba", runtime=100,
         axes=dict(story=7.0, craft=7.0, vision=7.5, weight=6.5), score=7.0,
         date="2026-09-25",
         verdict="An eleven-year-old from the private-school side spends one day as a mechanic's apprentice, and the workshop becomes a full society: Kunle Afolayan's warmest film and the shelf's pick for the best class-parable Nigerian cinema has made without preaching",
         body=[
"The premise is a dare of simplicity: Ponmile, the boss's nephew from the suburbs, is put to work for a day at his uncle's motor village - sweeping, fetching, being wound up, and slowly being taught - and screenwriter Tunde Babalola builds an entire Lagos economy inside one open-front garage. The day's structure gives the film its engine: customers arrive like scenes in a play, each carrying a class signal - the pastor with the borrowed SUV, the man who cannot pay, the woman who can pay and wants the work done right - and the workshop's code of conduct around them is the real plot. Nothing is smuggled in as spectacle; the richest thing the film steals is how normal competence looks when the camera finally points at it.",
"The craft is the director's stated love letter made physical: the workshop was built as a set and the cars are real, the soundscape of clanging, radios and arguing is mixed like a choir, and the ensemble plays apprenticeship with a documentarian's ear for how craft is actually passed - Femi Adebayo's foreman owns the floor with a wrench-handled calm, and young Tooni Afolayan carries the outsider-arc without a single pity beat. The cameos, from Burna Boy to the industry's own bench, are the film's wink at itself - Afolayan's most autobiographical project admits that everyone in Lagos grew up beside a motor village, and the film's craft thesis is that the people who fix the machines deserve the same lens as the people who own them.",
"The ledger's debits are the parable's: the day is tidier than the street, the hard edges of child labour and workshop economics get the soft-focus treatment, and the third act's reconciliation lands a beat too rehearsed - the desk's note is that Afolayan aims for affection where the subject could have survived anger. Its message-movie seams show most at the edges: the rich-kid-versus-workshop framing leans on symbols - the generator, the water, the borrowed car keys - a little harder than trust in the audience required.",
"Weight: the film premiered as the festival-and-streaming bridge project of its year - a Lagos workship story with Netflix in the picture and a generation of mechanics seeing their trade lit like a profession - and it sits on this shelf beside Living in Bondage and Citation as the desk's third proof that Afolayan's career is the industry's argument for ambition being a genre of its own. Judged as cinema: a warm, well-built day; judged as a gesture toward the people the industry usually casts as background, one of its best.",
         ]),
    dict(slug="the-set-up", title="The Set Up", year=2019,
         director="Niyi Akinmolayan", country="Nigeria", language="English", runtime=103,
         axes=dict(story=6.0, craft=6.5, vision=6.5, weight=6.0), score=6.25,
         date="2026-09-25",
         verdict="Three women, one con, and a twist ledger kept with a bookkeeper's literalism: the desk's verdict is a polished, watchable thriller whose appetite for reversals outspends its budget for belief - and Inkblot's most obvious lesson in why structure is a character",
         body=[
"The opening tells you it is a con story - a jailed ex-smuggler with a grudge is hired by a debt-cornered businessman to entrap a wealthy heiress into marriage - and Niyi Akinmolayan's film then executes the bait with real craft: the Lagos of film-one money is shot with a designer's eye, Adesua Etomi's heiress is allowed a mind before she's allowed a victim's role, and Kehinde Bankole's enforcer brings a physical seriousness the material needs to stay dangerous. For its first hour, the film runs the heist sub-genre's machinery - recruitment, rehearsal, close calls - tighter than most of its imports, and the desk logs that hour as genuinely very good Nollywood thriller work.",
"The craft is the company's house standard at its most visible: production design that reads as wealth rather than aspirational, an edit that keeps the cons legible (the hard part of any con film, and mostly passed), and a score that knows a reveal when it hears one. Dakore Akande's gambler-wife is the performance the room keeps stealing, and the cameos - Joke Silva and Tina Mba presiding over their own scenes - carry the film's self-awareness about class, which is its best theme: who in Lagos gets to be the one holding the plan.",
"The ledger's debits are what the mixed reviews filed under one word: twists. The third act re-litigates the plot once, then again, then a third time for the poster, and the reversals are individually directed well enough to land while collectively spending the audience's trust like a character with a stolen wallet - each reveal explaining scenes the film had just shown, which turns its own first two acts into foreshadowing with the safety pins showing. The emotional logic of the central trio gets mortgaged to the surprise mechanics; the climax's motive-reveal is delivered in the register of apology.",
"Weight: the shelf files it as the box-office-side data point of the FilmOne era - a well-made Lagos thriller that the public took to the multiplex and the critics split over in the exact places a writing room should study - plus the record that it is Akinmolayan's seventh feature and Inkblot's tenth, the studio-era moment when the industry's craft ceiling had risen enough that a flawed film looked this professional. Judged as a thriller: stylish and watchable, undone by its own arithmetic; judged as a lesson: the desk's standing example that in a con film, the twist you cannot afford is the one that cheats the characters.",
         ]),

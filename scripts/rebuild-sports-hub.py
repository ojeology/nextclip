...
<section class="sp-comp sp-explore">
  <div class="shell">
    ...
    <div class="sp-explore-grid">
      ...
      <a class="sp-comp-card" href="/sports/teams/" style="--card-img:url('/assets/img/sports/hero-arsenal.jpg')"><em>Clubs</em><b>Team pages</b><span>Fixtures, sourced results, form and BRYME matchweek comics for the biggest clubs.</span></a>

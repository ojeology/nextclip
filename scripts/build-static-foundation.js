...
fs.appendFileSync(path.join(root,'assets/site.css'), `\n/* Persistent navigation control */\n.bryme-back{position:fixed;left:14px;bottom:76px;z-index:80;display:inline-flex;align-items:center;gap:5px;border:1px solid rgba(255,255,255,.22);border-radius:20px;background:rgba(8,9,11,.88);backdrop-filter:blur(10px);color:#fff;font:800 12px/1 system-ui,sans-serif;padding:9px 12px;cursor:pointer;box-shadow:0 7px 22px rgba(0,0,0,.35)}.bryme-back:hover{border-color:var(--sports,#3ddc84);transform:translateX(-1px)}@media(max-width:760px){.bryme-back{left:10px;bottom:72px;padding:9px 11px}.bryme-back span{display:none}}\n`);
/* ------------------------------------------------------------------ */
...
/* ================================================================
   BRYME VERTICALS — Sports, Memes & Stickers, Make Money, Tech & AI,
...
const VERTICALS = [
  ...
  {
    dir: 'memes', emoji: '😂', name: 'BRYME Memes & Stickers', short: 'Memes & Stickers', active: 'memes', accent: '#ffd24a',
    tagline: 'Memes, reaction images, WhatsApp stickers and shareable fun.',
    desc: 'BRYME Memes & Stickers is a discovery and sharing destination for memes, reactions, funny images and WhatsApp stickers — including Nigerian and West African internet culture, football memes and relationship memes.',
    note: 'Copyright matters: we do not scrape random copyrighted images. Content is original, properly licensed, public-domain or user-submitted with permission. A user-submission and moderation system can be added later.',
    categories: [
      { slug: 'trending-memes', name: 'Trending Memes', desc: 'The memes people are sharing right now.' },
      { slug: 'reaction-memes', name: 'Popular Reactions', desc: 'Reaction memes for every situation.' },
      { slug: 'whatsapp-stickers', name: 'WhatsApp Stickers', desc: 'Sticker packs and how to get them on your phone.' },
      { slug: 'football-memes', name: 'Football Memes', desc: 'Ballon d\'Or drama, fan debates and football chaos.' },
      { slug: 'relationship-memes', name: 'Relationship Memes', desc: 'Love, situationships and everything in between.' },
      { slug: 'funny-savage', name: 'Funny & Savage', desc: 'The sharpest one-liners and most savage reactions.' },
      { slug: 'latest', name: 'Latest Memes', desc: 'The newest additions to the meme archive.' }
    ]
  },
  {
...
function verticalPage(v, category){
  ...
  const catGrid = (v.categories || []).map(c => `<a class="vcat" href="${url('/' + v.dir + '/' + c.slug + '/')}"><b>${esc(c.name)}</b><span>${esc(c.desc)}</span></a>`).join('') + (v.dir === 'memes' ? `<a class="vcat" href="${url('/memes/sticker-generator/')}"><b>✨ Sticker Generator</b><span>Turn your photo into a downloadable WhatsApp-ready sticker.</span></a><a class="vcat" href="${url('/memes/library/')}"><b>🔥 Reaction Pack Drop</b><span>48 downloadable reactions for WhatsApp, football banter and group chats.</span></a>` : '');
  ...
  const sportsFeature = (v.dir === 'sports' && !category) ? `<section class="sp-hero" aria-label="Featured BRYME Sports stories"><div class="sp-hero-track"><a class="sp-hero-card sp-hero-first" href="${url('/sports/premier-league/')}" style="--card-img:url('/assets/img/sports/hero-premier-league.jpg')"><span class="sp-hero-tag">Welcome to the Premier League</span><h3>The 2026/27 season starts here</h3><p>Fixtures, clubs, match pages and the stories that will define the campaign.</p><span class="sp-hero-go">Explore the season →</span></a><a class="sp-hero-card" href="${url('/sports/fpl/')}" style="--card-img:url('/assets/img/sports/hero-fpl.jpg')"><span class="sp-hero-tag">Fantasy Premier League</span><h3>Top FPL picks for the new season</h3><p>Start with the fixtures, the key decisions and the players worth watching.</p><span class="sp-hero-go">Build your FPL view →</span></a><a class="sp-hero-card" href="${url('/sports/managers-2026-27/')}" style="--card-img:url('/assets/img/sports/hero-man-city-manager.jpg')"><span class="sp-hero-tag">Manchester City</span><h3>Enzo Maresca: a new chapter at City</h3><p>Follow the manager changes and the early storylines around the Premier League.</p><span class="sp-hero-go">See managers in &amp; out →</span></a></div></section>` : '';
  const footballVideoCarousel = `<section class="hero-carousel" data-hero role="region" aria-roledescription="carousel" aria-label="Featured football and sport videos" data-interval="8000"><div class="hero-slides"><div class="hero-slide is-active" data-slide data-video="Ow0lB4bfiPg" data-title="Premier League" data-url="/sports/fpl/" style="background-image:url('https://i.ytimg.com/vi/Ow0lB4bfiPg/hqdefault.jpg')"><div class="hero-slide-shade"></div><div class="shell hero-slide-inner"><div class="hero-slide-kicker"><span class="type-badge tb-sports">FPL</span><span>Official YouTube</span></div><h1>Premier League</h1><p>How A NO Haaland Draft Looks | FPL Podcast 2026/27</p><div class="hero-actions"><button type="button" class="cta hero-watch" data-hero-watch>▶ Play video</button><a class="cta cta-ghost" href="/sports/fpl/">Explore FPL</a></div></div></div><div class="hero-slide" data-slide data-video="Hd0lqKA_NXo" data-title="LALIGA EA SPORTS" data-url="/sports/la-liga/" style="background-image:url('https://i.ytimg.com/vi/Hd0lqKA_NXo/hqdefault.jpg')"><div class="hero-slide-shade"></div><div class="shell hero-slide-inner"><div class="hero-slide-kicker"><span class="type-badge tb-sports">La Liga</span><span>Official YouTube</span></div><h1>LALIGA EA SPORTS</h1><p>Best Matchday 1 matches in LaLiga</p><div class="hero-actions"><button type="button" class="cta hero-watch" data-hero-watch>▶ Play video</button><a class="cta cta-ghost" href="/sports/la-liga/">Explore La Liga</a></div></div></div><div class="hero-slide" data-slide data-video="YrJuuVxyXXM" data-title="Bundesliga" data-url="/sports/bundesliga/" style="background-image:url('https://i.ytimg.com/vi/YrJuuVxyXXM/hqdefault.jpg')"><div class="hero-slide-shade"></div><div class="shell hero-slide-inner"><div class="hero-slide-kicker"><span class="type-badge tb-sports">Bundesliga</span><span>Official YouTube</span></div><h1>Bundesliga</h1><p>Players You Never Knew Played in the Bundesliga</p><div class="hero-actions"><button type="button" class="cta hero-watch" data-hero-watch>▶ Play video</button><a class="cta cta-ghost" href="/sports/bundesliga/">Explore Bundesliga</a></div></div></div><div class="hero-slide" data-slide data-video="ZUq8iUrGeac" data-title="UFC" data-url="/sports/boxing-mma/" style="background-image:url('https://i.ytimg.com/vi/ZUq8iUrGeac/hqdefault.jpg')"><div class="hero-slide-shade"></div><div class="shell hero-slide-inner"><div class="hero-slide-kicker"><span class="type-badge tb-sports">MMA</span><span>Official YouTube</span></div><h1>UFC</h1><p>UFC 330 Embedded: Vlog Series</p><div class="hero-actions"><button type="button" class="cta hero-watch" data-hero-watch>▶ Play video</button><a class="cta cta-ghost" href="/sports/boxing-mma/">Explore MMA</a></div></div></div><div class="hero-slide" data-slide data-video="zbjvLhCSgMI" data-title="NBA" data-url="/sports/basketball/" style="background-image:url('https://i.ytimg.com/vi/zbjvLhCSgMI/hqdefault.jpg')"><div class="hero-slide-shade"></div><div class="shell hero-slide-inner"><div class="hero-slide-kicker"><span class="type-badge tb-sports">Basketball</span><span>Official YouTube</span></div><h1>NBA</h1><p>The MVP Season That Made Russell Westbrook Immortal</p><div class="hero-actions"><button type="button" class="cta hero-watch" data-hero-watch>▶ Play video</button><a class="cta cta-ghost" href="/sports/basketball/">Explore Basketball</a></div></div></div></div><div class="hero-video" data-hero-video hidden></div><button class="hero-ctrl hero-prev" type="button" data-hero-prev aria-label="Previous video">‹</button><button class="hero-ctrl hero-next" type="button" data-hero-next aria-label="Next video">›</button><button class="hero-vctrl hero-pause" type="button" data-hero-pause aria-label="Pause rotation">⏸</button><button class="hero-vctrl" type="button" data-hero-mute hidden aria-label="Unmute video">🔇</button><div class="hero-dots"><button class="hero-dot is-active" type="button" data-hero-dot="0" aria-label="Show slide 1"></button><button class="hero-dot" type="button" data-hero-dot="1" aria-label="Show slide 2"></button><button class="hero-dot" type="button" data-hero-dot="2" aria-label="Show slide 3"></button><button class="hero-dot" type="button" data-hero-dot="3" aria-label="Show slide 4"></button><button class="hero-dot" type="button" data-hero-dot="4" aria-label="Show slide 5"></button></div></section>`;
  const footballHub = footballVideoCarousel + `<section class="section"><div class="vnote">Football is BRYME’s first fully built sports hub. Pick a competition or follow fixtures, FPL, transfers and the game’s biggest stories.</div><h2 style="margin:26px 0 14px">Football competitions</h2><div class="vcat-grid"><a class="vcat" href="${url('/sports/premier-league/')}"><b>Premier League</b><span>England’s top flight: fixtures, clubs, transfers and FPL.</span></a><a class="vcat" href="${url('/sports/champions-league/')}"><b>Champions League</b><span>Europe’s biggest club competition.</span></a><a class="vcat" href="${url('/sports/la-liga/')}"><b>La Liga</b><span>Spanish football: Real Madrid, Barcelona and beyond.</span></a><a class="vcat" href="${url('/sports/serie-a/')}"><b>Serie A</b><span>Italian football and its storied clubs.</span></a><a class="vcat" href="${url('/sports/bundesliga/')}"><b>Bundesliga</b><span>German football and its fan culture.</span></a><a class="vcat" href="${url('/sports/ligue-1/')}"><b>Ligue 1</b><span>French football, fixtures and clubs.</span></a><a class="vcat" href="${url('/sports/international/')}"><b>International football</b><span>National teams, tournaments and qualifiers.</span></a></div><h2 style="margin:30px 0 14px">Follow the game</h2><div class="vcat-grid"><a class="vcat" href="${url('/sports/fpl/')}"><b>Fantasy Premier League</b><span>Picks, captains and fixture-led decisions.</span></a><a class="vcat" href="${url('/sports/transfers/')}"><b>Transfers</b><span>Verified transfer coverage and market context.</span></a><a class="vcat" href="${url('/sports/players/')}"><b>Players</b><span>Profiles, careers and stories.</span></a><a class="vcat" href="${url('/sports/clubs/')}"><b>Clubs</b><span>Histories, identities and fan culture.</span></a><a class="vcat" href="${url('/sports/history/')}"><b>History</b><span>Historic moments and great eras.</span></a><a class="vcat" href="${url('/sports/records/')}"><b>Records</b><span>Goals, titles, appearances and numbers.</span></a></div></section>`;
  ...
  const body = `<main class="shell"><div class="crumb"><a href="${url('/')}">Home</a> / ${category ? `<a href="${url('/' + v.dir + '/')}">${esc(v.name)}</a> / ${esc(category.name)}` : esc(v.name)}</div>${pageHero}<section class="section">${category ? (v.dir === 'sports' && category.slug === 'football' ? footballHub : `<div class="vstate"><b>${esc(category.name)} — foundation ready</b><p>This section is being built. Articles will appear here as they are researched and published.</p></div>`) : `<p class="lead" style="margin-bottom:18px">${esc(v.desc)}</p><div class="vnote">${esc(v.note)}</div><h2 style="margin:26px 0 14px">Explore ${esc(v.short)}</h2><div class="vcat-grid">${catGrid}</div>`}</section>${fixturesBlock}${sportsStoriesBlock}<section class="section"><div class="section-head"><h2>Explore BRYME</h2></div><div class="vchips">${VERTICALS.map(verticalChip).join('')}</div></section></main>`;
...
write('', layout({
  ...
  schema: [{ '@context':'https://schema.org', '@type':'WebSite', name:site.name, url:url('/'), description:site.description }, { '@context':'https://schema.org', '@type':'CollectionPage', name:'BRYME – Discover Entertainment, Sports, Memes, Money & Tech', url:url('/') }],
  body: `<main>
...
function fixturesResults(){
  for (const lg of LEAGUE_FIX) {
    ...
    const bodyR = `<main class="shell"><div class="crumb"><a href="${url('/')}">Home</a> / <a href="${url('/sports/')}">BRYME Sports</a> / <a href="${url('/sports/' + lg.slug + '/')}">${esc(F.league)}</a> / Results</div>
      ...
      <p class="sp-updated">Last updated: ${esc(F.lastUpdated || 'Pending verification')}</p>
      <div class="vstate"><b>No matches played yet</b><p>The ${esc(F.season)} ${esc(F.league)} season ${(F.matchweeks && F.matchweeks[0] && F.matchweeks[0].matches[0]) ? 'starts ' + esc(F.matchweeks[0].matches[0].dayLabel) : 'has not started'} — so as of ${esc(F.lastUpdated || 'today')} no league fixtures have been played and there are no results to show. When matches are played, the official result and match data are added here after full-time — verified only.</p></div>
      ${nextBlock}
...
const verticalPaths = ['/entertainment/','/memes/sticker-generator/','/memes/library/','/sports/articles/'].concat(VERTICALS.flatMap(v => ['/' + v.dir + '/'].concat((v.categories || []).map(c => '/' + v.dir + '/' + c.slug + '/'))));
const paths = ['/','/movies/','/series/','/anime/','/trending/','/genres/','/years/','/topics/','/articles/', ...legalPaths, ...verticalPaths, ...sportsExtraPaths, ...LEAGUE_MATCH_PATHS, ...genrePaths, ...movies.map(m => `/${m.typeDir || 'movie'}/${m.slug}/`), ...[...yearMap.keys()].map(y => `/year/${y}/`), ...[...seriesYearMap.keys()].map(y => `/series/${y}/`), ...[...animeYearMap.keys()].map(y => `/anime/${y}/`), ...articles.map(a => `/article/${a.slug}/`), ...topics.map(t => `/topic/${t.slug}/`), ...[...articleCategoryMap.keys()].map(s => `/articles/${s}/`)];

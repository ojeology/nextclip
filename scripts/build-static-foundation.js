...
for (const [year, list] of seriesYearMap) write(`series/${year}`, layout({
  title: `Series from ${year}`, description: `Explore TV series from ${year} in the NEXTCLIP catalogue.`, path: `/series/${year}/`, activeNav: 'series',
...
for (const [year, list] of animeYearMap) write(`anime/${year}`, layout({
  title: `Anime from ${year}`, description: `Explore anime from ${year} in the NEXTCLIP catalogue.`, path: `/anime/${year}/`, activeNav: 'anime',

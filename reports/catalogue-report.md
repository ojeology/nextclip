...
Generated: 2026-08-19T10:56:25.100Z
...
- With verified trailers: **608**
- Without trailers: **30**
- With editorial ratings: **127**
- With country data: **629** / language: **629**

## Genre coverage (per type)
- Movie genres: `sci-fi` (52), `action` (72), `drama` (60), `korean` (2), `horror` (40), `superhero` (55), `animation` (41), `war` (7), `fantasy` (15), `thriller` (32), `comedy` (33), `romance` (10), `crime` (18), `nigerian` (14), `french` (3), `indian` (13), `chinese` (12), `western` (2), `german` (2)

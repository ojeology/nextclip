# Niche readiness ratings — 2026-09-10 (post header-port, commit a68051e747)

Measured: pages / total words in <main> / median words per page, full clean chain 825 pages / 85,148 links OK.

| Rank | Niche | Pages | Words | Median | Grade | One-line verdict |
|---|---|---|---|---|---|---|
| 1 | Writers | 495 | 381,194 | 694 | **A — ready now** | Flagship in fact, not just name. Guides, tools, opportunities, glossary, jobs, full trust pages. The standard others copy. |
...
## Site-level gates before ANY niche is "used" publicly
1. thebryme.com custom domain (user-side, LAST) — sitemaps/canonicals still point at bryme.onrender.com.
2. Repo rename + Render blueprint sync (user-side).
3. GitHub token revoke (security hygiene, requested ×27).
4. Optional when traffic starts: analytics, IndexNow key.
